                ...
                <tbody>
                    <?php foreach ($tickets as $t): ?>
                        ...
                        elseif ($estatus_raw === 'EN PROCESO')
                            $clase = 'proceso';
                        elseif ($horas_pasadas >= 24 && $estatus_raw === 'ABIERTO') {
                            $clase = 'urgente';
                        ...
                        <tr>
                            ...
                            <?php if ($rol_sesion !== 'Solicitante'): ?>
                                <td>
                                    <span
                                        class="nombre-solicitante"><?php echo htmlspecialchars($t['nombre_persona'] ?? 'N/A'); ?></span>
                                    <span
                                        class="info-secundaria"><?php echo htmlspecialchars($t['departamento_origen'] ?? 'Sin Ubicación'); ?></span>
                                </td>
                            <?php endif; ?>
                            <td><strong><?php echo htmlspecialchars($t['tecnico'] ?? 'Pendiente'); ?></strong></td>
                            <td style="text-align: center;">
                                <span
                                    class="status-pill <?php echo $clase; ?>"><?php echo htmlspecialchars($texto); ?></span>
                                <?php if ($estatus_raw === 'ABIERTO' && ($rol_sesion === 'Tecnico' || $rol_sesion === 'Especialista')): ?>
                                    <form method="POST" style="margin:0;"><input type="hidden" name="aceptar_id"
                                            value="<?php echo $t['id']; ?>"><button type="submit"
                                            class="btn-aceptar">ACEPTAR</button></form>
                                <?php endif; ?>
                            </td>
                            <td data-fecha="<?php echo date('Y-m-d', strtotime($t['fechainicial'])); ?>"
                                style="font-size: 0.85em; color: #666;">
                                <?php echo date('d/m/Y h:i A', strtotime($t['fechainicial'])); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
